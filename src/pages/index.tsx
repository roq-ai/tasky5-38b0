  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Tasky5: Your ultimate solution for managing tasks. Streamline your to-do list, prioritize your work, and accomplish more with our powerful app."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Tasky5: Your ultimate solution for managing tasks. Streamline your to-do list, prioritize your work, and accomplish more with our powerful app.`}
            </Text>
            <Box
